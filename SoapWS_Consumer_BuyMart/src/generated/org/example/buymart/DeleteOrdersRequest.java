 ...
 *       &lt;sequence>
 *         &lt;element name="CustomerId" type="{http://www.w3.org/2001/XMLSchema}integer" maxOccurs="unbounded"/>
 *         &lt;element name="OrderId" type="{http://www.w3.org/2001/XMLSchema}integer" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeleteOrdersRequest {
    ...
    protected List<BigInteger> orderId;
     ...
     * 
     */
    public List<BigInteger> getOrderId() {
        if (orderId == null) {
            orderId = new ArrayList<BigInteger>();
        }
        return this.orderId;
    }
